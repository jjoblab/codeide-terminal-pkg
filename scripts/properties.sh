...
##
TERMUX_APP__PACKAGE_NAME="jo.codeide"
...
# Default value: `com.termux`
##
TERMUX_APP__NAMESPACE="jo.codeide"
...
TERMUX_REPO_APP__PACKAGE_NAME="jo.codeide"
TERMUX_REPO_APP__DATA_DIR="/data/data/$TERMUX_REPO_APP__PACKAGE_NAME"
TERMUX_REPO__CORE_DIR="$TERMUX_REPO_APP__DATA_DIR/termux/core"
TERMUX_REPO__APPS_DIR="$TERMUX_REPO_APP__DATA_DIR/termux/app"
TERMUX_REPO__ROOTFS="$TERMUX_REPO_APP__DATA_DIR/files"
TERMUX_REPO__HOME="$TERMUX_REPO__ROOTFS/home"
TERMUX_REPO__PREFIX="$TERMUX_REPO__ROOTFS/usr"
